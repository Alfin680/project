...
const Signup = () => {
  ...
  return (
    <div style={{textAlign: "center"}}>
        ...
        <TextField required id="Height" {...register('Height')}label="Height" variant="outlined"/><br></br><br></br>
        <TextField required id="Weight" {...register('Weight')}label="Weight" variant="outlined"/><br></br><br></br>
        <TextField required id="Phone" {...register('Phone')}label="Phone no:" variant="outlined"/><br></br><br></br>
        <TextField required id="Blood" {...register('Blood')}label="Blood Group" variant="outlined"/><br></br><br></br>
        <TextField required id="Address" {...register('Address')}label="Address" variant="outlined"/><br></br><br></br>
